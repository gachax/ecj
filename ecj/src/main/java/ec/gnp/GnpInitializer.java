...
public class GnpInitializer extends SimpleInitializer {
    ...
    private Map<Integer, int[]> nodeGeneMap = new HashMap<>();
    private Map<String, int[]> subnodeGeneMap = new HashMap<>();
    private Map<String, int[]> subnodeParamsGeneMap = new HashMap<>();
    private Map<String, int[]> branchesGeneMap = new HashMap<>();

    //The count of the genes at node level. One gene, which holds the information about the count of the subnodes.
    private final static int NODE_GENE_COUNT = 1;
    ...
    private final static int SUBNODE_GENE_COUNT = 2;
    //The count of the genes at branch level. Holds the information about the linked node.
    private final static int BRANCH_GENE_COUNT = 1;
    ...
    private Parameter subnodeParametersParameter;
    ...
    private Map<String, String> subnodeCountSegmentProperties = new HashMap<>();
    private Map<String, String> judgementFunctionIdSegmentProperties = new HashMap<>();
    private Map<String, String> processingFunctionIdSegmentProperties = new HashMap<>();
    private Map<String, String> connectionsSegmentProperites = new HashMap<>();
    ...
    public String getSubnodeParamsGeneMapKey(int nodeId, int subnodeId, int parameterId) {
        return String.valueOf(nodeId) + "|" + subnodeId + "|" + parameterId;
    }

    public String getSubnodeGeneMapKey(int nodeId, int subnodeId) {
        return String.valueOf(nodeId) + "|" + subnodeId;
    }

    public String getBranchGeneMapKey(Integer nodeId, int branchId) {
    ...
    public Map<String, int[]> getSubnodeGeneMap() {
        return subnodeGeneMap;
    }

    public Map<String, int[]> getSubnodeParamsGeneMap() {
        return subnodeParamsGeneMap;
    }

    public Map<String, int[]> getBranchesGeneMap() {
    ...
    public Map<Integer, int[]> getNodeGeneMap() {
        return nodeGeneMap;
    }

    int getSubnodeParemetersCount() {
        return subnodeParemetersCount;
    }

    Parameter getSubnodeParametersParameter() {
        return subnodeParametersParameter;
    }
